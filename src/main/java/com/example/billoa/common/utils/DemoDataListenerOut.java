...
@Slf4j
public class DemoDataListenerOut implements ReadListener<Outbill> {
     ...
     * 缓存的数据
     */
    private List<Outbill> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
     ...
     *
     */
    public DemoDataListenerOut(OutbillServiceImpl outbillService) {
     ...
     */
    @Override
    public void invoke(Outbill data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        outbillService.save(cachedDataList);
        log.info("存储数据库成功！");
    }
}
